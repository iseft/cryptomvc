...
<h2>Edit exchange details</h2>
    ...
    <form action="https://<?php echo URLROOT ?>/exchanges/edit/<?= $data['exchange']->id ?>" method="POST">
    ...
    <p class="back"><i class="fas fa-backward back"></i> <a href="https://<?php echo URLROOT; ?>/exchanges/show">Back to Exchanges</a></p>
